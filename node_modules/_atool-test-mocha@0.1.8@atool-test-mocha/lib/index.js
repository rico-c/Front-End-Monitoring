...
exports.default = function (config) {
  ...
  var compiler = config.customCompiler ? (0, _path.join)(cwd, config.customCompiler) : (0, _path.join)(__dirname, 'compiler');
  ...
  if (config.coverage) {
    mochaBin = (0, _path.join)(__dirname, '../node_modules/.bin/_mocha');
    if (!_fs2.default.existsSync(mochaBin)) {
    ...
    mochaBin = (0, _path.join)(__dirname, '../node_modules/.bin/mocha');
    if (!_fs2.default.existsSync(mochaBin)) {
